...
imwrite(uint8(XRS),'Ex1A21.png');
imwrite(uint8(X0),'Ex1A22.png');
imwrite(uint8(XB10),'Ex1A23.png');
imwrite(uint8(XB20),'Ex1A24.png');
% 
% figure(1)
% %subplot(2,2,1);
% imshow(uint8(XRS)),
...
% subplot(2,2,3);
% imshow(uint8(XB10)),
% title('(c) Restored image of first partition')
% subplot(2,2,4);
% imshow(uint8(XB20)),
% title('(d) Restored image of second partition')
